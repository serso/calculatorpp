...
// Database settings:
define('DB_DSN', 'mysql:dbname=cpp_db;host=sql136.your-server.de;port=3306');
define('DB_USER', '');
define('DB_PASS', '');
define('TABLE_PREFIX', '');
...
define('URL_PUBLIC', 'http://se.solovyev.org/cpp/');
...
// To enable mod_rewrite, you must also change the name of ".htaccess" in your
